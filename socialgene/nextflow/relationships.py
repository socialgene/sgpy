...
class ENCODES(Relationship):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            neo4j_label="ENCODES",
            description="Represents the relationship between a nucleotide sequence and a protein",
...
class MAINROLE_ANN(Relationship):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            ...
            start=Nodes.TIGRFAM_ROLE,
            end=Nodes.TIGRFAM_MAINROLE,
        )
...
class MMSEQS2(Relationship):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            neo4j_label="MMSEQS2",
            description="Represents the relationship between two proteins calculated with MMseqs2",
