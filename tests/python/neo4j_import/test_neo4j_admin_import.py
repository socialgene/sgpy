...
expected_headers = {
    ...
    "amrfinder_hmm_source": ":IGNORE\taccession\tid:ID(amrfinder)\tdescription\tcategory\r\n",
    "local_hmm_source": ":IGNORE\taccession\tid:ID(local)\tdescription\tcategory\r\n",
    "tigrfam_subrole": "id:ID(tigrfam_subrole)\r\n",
    "classiphage_hmm_source": ":IGNORE\taccession\tid:ID(classiphage)\tdescription\tcategory\r\n",
    ...
    "prism_hmm_source": ":IGNORE\taccession\tid:ID(prism)\tdescription\tcategory\r\n",
    "antismash_hmm_source": ":IGNORE\taccession\tid:ID(antismash)\tdescription\tcategory\r\n",
    "amrfinder_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(amrfinder)\t:IGNORE\t:IGNORE\r\n",
    "pfam_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(pfam)\t:IGNORE\t:IGNORE\r\n",
    "sg_hmm_nodes": "id:ID(hmm)\tmodel_length\r\n",
    "mmseqs2": ":START_ID(protein)\t:END_ID(protein)\r\n",
    "ipresto_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(ipresto)\t:IGNORE\t:IGNORE\r\n",
    ...
    "resfams_hmm_source": ":IGNORE\taccession\tid:ID(resfams)\tdescription\tcategory\r\n",
    "virus_orthologous_groups_hmm_source": ":IGNORE\taccession\tid:ID(virus_orthologous_groups)\tdescription\tcategory\r\n",
    "tigrfam_hmm_source": ":IGNORE\taccession\tid:ID(tigrfam)\tdescription\tcategory\r\n",
    ...
    "ipresto_hmm_source": ":IGNORE\taccession\tid:ID(ipresto)\tdescription\tcategory\r\n",
    "prism_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(prism)\t:IGNORE\t:IGNORE\r\n",
    "assembly_to_locus": ":END_ID(assembly)\t:START_ID(nucleotide)\r\n",
    "resfams_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(resfams)\t:IGNORE\t:IGNORE\r\n",
    "classiphage_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(classiphage)\t:IGNORE\t:IGNORE\r\n",
    "locus_to_protein": ":START_ID(nucleotide)\t:END_ID(protein)\tstart:int\tend:int\tstrand:int\r\n",
    "bigslice_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(bigslice)\t:IGNORE\t:IGNORE\r\n",
    ...
    "local_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(local)\t:IGNORE\t:IGNORE\r\n",
    "mz_source_file": "id:ID(mz_source_file)\r\n",
    "cluster_to_source_file": ":END_ID(mz_cluster_index)\t:START_ID(mz_source_file)\r\n",
    "bigslice_hmm_source": ":IGNORE\taccession\tid:ID(bigslice)\tdescription\tcategory\r\n",
    "antismash_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(antismash)\t:IGNORE\t:IGNORE\r\n",
    "pfam_hmm_source": ":IGNORE\taccession\tid:ID(pfam)\tdescription\tcategory\r\n",
    ...
    "tigrfam_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(tigrfam)\t:IGNORE\t:IGNORE\r\n",
    "taxid_to_taxid": ":START_ID(taxid)\t:END_ID(taxid)\r\n",
    "virus_orthologous_groups_hmm_source_relationships": ":START_ID(hmm)\t:IGNORE\t:END_ID(virus_orthologous_groups)\t:IGNORE\t:IGNORE\r\n",
}
