...
def test_queries_havent_changed():
    assert {k: hasher(v["query"]) for k, v in query_dict.items()} == {
        ...
        "get_species_and_assembly_from_protein_list": "3e4d3d914c173c2f9612686f3cea9327",
        "get_class_taxid_from_assembly_id": "6d8d157b43e0063aaca395d3dfaac236",
        "get_genus_taxid_from_assembly_id": "1e8b9f890647312108d421e7b30369a5",
