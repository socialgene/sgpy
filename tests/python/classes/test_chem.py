...
aspirin_hash_dict = {
    ...
    "HetAtomProtomerv2": "[C]:[C](:[O]):[O]:[C]1:[C]:[C]:[C]:[C]:[C]:1:[C](:[O]):[O]_8",
...
def test_ChemicalCompound_smiles2():
    ...
    assert compound.hash_dict == {
        ...
        "HetAtomProtomerv2": "[CH3]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[C]:[C](:[O]):[N]:[C](-[CH2]-[C]1:[C]:[N]:[C]2:[C]:[C]:[C]:[C]:[C]:1:2):[C](:[O]):[N]:[C](-[C]:[C](:[N]):[O]):[C](:[O]):[N]:[C](-[C]:[C](:[O]):[O]):[C](:[O]):[N]:[C]1:[C](:[O]):[N]:[C]:[C](:[O]):[N]:[C](-[CH2]-[CH2]-[CH2]-[NH2]):[C](:[O]):[N]:[C](-[C]:[C](:[O]):[O]):[C](:[O]):[N]:[C](-[CH3]):[C](:[O]):[N]:[C](-[C]:[C](:[O]):[O]):[C](:[O]):[N]:[C]:[C](:[O]):[N]:[C](-[CH2]-[OH]):[C](:[O]):[N]:[C](-[CH](-[CH3])-[C]:[C](:[O]):[O]):[C](:[O]):[N]:[C](-[C]:[C](:[O]):[C]2:[C]:[C]:[C]:[C]:[C]:2:[N]):[C](:[O]):[O]-[CH]-1-[CH3]_60",
