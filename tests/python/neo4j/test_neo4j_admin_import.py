...
expected_headers = {
    ...
    "protein_to_hmm_header": ":END_ID(protein)\t:START_ID(hmm)\tenv_from:Integer\tenv_to:Integer\tseq_pro_score:Float\tevalue:Float\ti_evalue:Float\tdomain_bias:Float\tdomain_score:Float\tseq_pro_bias:Float\thmm_from:Integer\thmm_to:Integer\tali_from:Integer\tali_to:Integer\texponentialized:Boolean\r\n",
    "mmseqs2": ":START_ID(protein)\t:END_ID(protein)\r\n",
    "blastp": ":START_ID(protein)\t:END_ID(protein)\tpident:Float\tlength:Integer\tmismatch:Integer\tgapopen:Integer\tqstart:Integer\tqend:Integer\tsstart:Integer\tsend:Integer\tevalue:Float\tbitscore:Float\tqcovhsp:Float\r\n",
    ...
    "mz_cluster_index_nodes": "uid:ID(mz_cluster_index)\tcomponent_index:Integer\tparent_mass:Float\tprecursor_mass:Float\tsum_precursor_intensity:Float\tSmiles:String\trt_mean::Float\trt_std_err:Float\tlibrary_id:String\tmq_score:Float\tmz_error_ppm:Float\tmass_diff:String\r\n",
    ...
    "locus_to_protein": ":START_ID(nucleotide)\t:END_ID(protein)\tprotein_id\tlocus_tag\tstart:Integer\tend:Integer\tstrand:Integer\tdescription\tpartial_on_complete_genome:Boolean\tmissing_start:Boolean\tmissing_stop:Boolean\tIntegerernal_stop:Boolean\tpartial_in_the_middle_of_a_contig:Boolean\tmissing_N_terminus:Boolean\tmissing_C_terminus:Boolean\tframeshifted:Boolean\ttoo_short_partial_abutting_assembly_gap:Boolean\tincomplete:Boolean\r\n",
