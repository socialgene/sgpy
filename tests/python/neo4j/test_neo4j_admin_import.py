...
expected_headers = {
    ...
    "protein_to_hmm_header": ":END_ID(protein)\t:START_ID(hmm)\tenv_from:Float\tenv_to:Float\tseq_pro_score:Double\tevalue:Double\ti_evalue:Double\tdomain_bias:Double\tdomain_score:Double\tseq_pro_bias:Double\thmm_from:Float\thmm_to:Float\tali_from:Float\tali_to:Float\texponentialized:Boolean\r\n",
    "mmseqs2": ":START_ID(protein)\t:END_ID(protein)\r\n",
    "blastp": ":START_ID(protein)\t:END_ID(protein)\tpident:Double\tlength:Float\tmismatch:Float\tgapopen:Float\tqstart:Float\tqend:Float\tsstart:Float\tsend:Float\tevalue:Double\tbitscore:Double\tqcovhsp:Double\r\n",
    ...
    "mz_cluster_index_nodes": "uid:ID(mz_cluster_index)\tcomponent_index:Float\tparent_mass:Double\tprecursor_mass:Double\tsum_precursor_intensity:Double\tSmiles:String\trt_mean::Double\trt_std_err:Double\tlibrary_id:String\tmq_score:Double\tmz_error_ppm:Double\tmass_diff:String\r\n",
